  ...
  <div class="jqr-width-100">
    <el-header class="header">
      <div class="header-breadcrumb">
        <el-breadcrumb separator="/">
          ...
          >
          <el-breadcrumb-item
            ><a href="/my/rbac/admin">管理员管理</a></el-breadcrumb-item
          >
        </el-breadcrumb>
      </div>
    ...
    <el-main class="main">
      <div class="table-bars">
        <el-button type="danger" icon="el-icon-plus" @click="toAdd">添加管理员</el-button>
      </div>
    ...
    <el-dialog title="管理员编辑" width="60%" :visible.sync="dialogFormVisible">
  ...
  methods: {
    getUsers(current) {
      let page = {
        current: current,
        size: 10,
        colums: ["id", "user_name", "user_type", "state"],
      };
