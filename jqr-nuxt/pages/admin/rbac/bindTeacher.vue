  ...
  <div class="jqr-width-100">
    <el-header class="header">
      <div class="header-breadcrumb">
        <el-breadcrumb separator="/">
          ...
          >
          <el-breadcrumb-item
            ><a href="/my/rbac/bindTeacher">绑定教师管理</a></el-breadcrumb-item
          >
        </el-breadcrumb>
      </div>
    ...
    <el-main class="main">
      ...
      >
        ...
        <el-table-column prop="teacher.teacherNo" label="工号">
        </el-table-column>
        <el-table-column prop="teacher.teacherName" label="姓名">
        </el-table-column>
        <el-table-column prop="teacher.professional" label="职称" width="100"> </el-table-column>
        <el-table-column prop="teacher.depart" label="班级" width="150">
        </el-table-column>
        <el-table-column prop="teacher.school" label="学校" width="150"> </el-table-column>
